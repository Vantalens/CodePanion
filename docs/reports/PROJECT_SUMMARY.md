...
> 历史快照：本文记录的是早期“智能开发助手工具”定位下的总结，不代表当前产品定义。
>
> 当前定位已经调整为“个人本地 AI 工作流中控台”，后续演进请参见 `docs/PRODUCT_ROADMAP.md`。

## 项目概述

在当时的产品定义下，RemindAI 被描述为一个智能开发助手工具，专为使用 AI 编程工具（如 Claude Code、GitHub Copilot CLI）的开发者设计。该表述已被后续的“个人本地 AI 工作流中控台”定位取代。
